...
describe(" PATCH /api/articles/:article_id", () => {
  ...
  xtest("404 : Responds with message -'Not Found' when article id is valid but does not exist", () => {
    const newVotes = { inc_votes: -100 };
    return request(app)
  ...
  xtest("400: Responds with message -'Bad Request' when newVotes has a missing key/malformed request ", () => {
